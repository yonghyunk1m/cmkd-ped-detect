...
| **LogitKD + TFD-Label** | **73.7 ± 1.7** | 72.6 | 74.7 | **0.318** | 1.60 | **0.033*** |
| **Hybrid + TFD-Label** | 73.6 ± 1.8 | **72.9** | 74.3 | 0.318 | **1.72** | **0.026*** |
...
# LogitKD + TFD-Label (LOSO)
bash runners/run_kd_loso.sh configs/kd_logit_unw_immune.yaml   # 'immune' = TFD-Label mask
...
Note: config files use the internal name `immune` for the TFD-Label mask and `selective` for TFD-Conf.

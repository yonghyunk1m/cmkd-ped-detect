...
Paper configurations (all binary, 5-fold LOSO on ASPED v.a):
    LogitKD            → configs/kd_logit_unw.yaml
    LogitKD + TFD      → configs/kd_logit_unw_tfd.yaml   ('tfd' = TFD mask)
    Hybrid + TFD       → configs/kd_hybrid_logit_cosine_tfd.yaml
    (see configs/ for the full set of 11 compared configurations)
"""

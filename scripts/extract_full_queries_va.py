...
Source: /path/to/ASPED.a_video/{session}/{location}/Video/*.mp4
Output: /path/to/teacher_embeddings_full/
"""
...
VIDEO_ROOT = "/path/to/ASPED.a_video"
OUTPUT_DIR = "/path/to/teacher_embeddings_instance_full"

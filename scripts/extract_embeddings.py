...
Datasets:
  V.B: Videos already at 1 FPS (pre-downsampled)
       /path/to/ASPED_v.b_video/{session}/{location}/Video/{clip_id}.mp4
       Labels: /path/to/ASPED_v.b/{session}/{location}/Labels/{clip_id}.csv
  ...
  V.C: Raw GoPro videos at ~30 FPS, one per (session, location)
       ...
       Labels: /path/to/ASPED_v.c/{session}/{location}/Labels/{clip_id}.csv
...
VB_VIDEO_ROOT  = "/path/to/ASPED_v.b_video"
VB_LABEL_ROOT  = "/path/to/ASPED_v.b"
VB_OUTPUT_DIR  = "/path/to/teacher_embeddings_vb"

VC_VIDEO_ROOT  = "/path/to/ASPED.c"
VC_LABEL_ROOT  = "/path/to/ASPED_v.c"
VC_META_CSV    = "/path/to/ASPED.c/video_and_label_clip_metadata.csv"
VC_OUTPUT_DIR  = "/path/to/teacher_embeddings_vc"

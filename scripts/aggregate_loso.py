...
Usage:
    python scripts/aggregate_loso.py --methods baseline_binary_v1 kd_logit_unw kd_logit_unw_tfd kd_hybrid_logit_cosine_tfd
...
def main():
    ...
    if args.all:
        ...
        methods = ["baseline_binary_v1", "kd_logit_unw",
                    "kd_logit_unw_tfd", "kd_hybrid_logit_cosine_tfd"]

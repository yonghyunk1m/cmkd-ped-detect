...
EXPERIMENTS = {
    # name: (config_path, is_kd)
    "baseline_binary_v1":                ("configs/baseline_binary_v1.yaml", False),
    "kd_logit_unw":                      ("configs/kd_logit_unw.yaml", True),
    "kd_logit_mtl":                      ("configs/kd_logit_mtl.yaml", True),
    "kd_logit_unw_classweight":          ("configs/kd_logit_unw_classweight.yaml", True),
    "kd_logit_unw_blend_07":             ("configs/kd_logit_unw_blend_07.yaml", True),
    "kd_logit_unw_blend_07_classweight": ("configs/kd_logit_unw_blend_07_classweight.yaml", True),
    "kd_logit_unw_immune":               ("configs/kd_logit_unw_immune.yaml", True),
    "kd_logit_unw_immune_classweight":   ("configs/kd_logit_unw_immune_classweight.yaml", True),
    "kd_logit_unw_selective":            ("configs/kd_logit_unw_selective.yaml", True),
    "kd_logit_unw_256dim":               ("configs/kd_logit_unw_256dim.yaml", True),
    "kd_logit_unw_256dim_selective":     ("configs/kd_logit_unw_256dim_selective.yaml", True),
    "kd_logit_alpha01":                  ("configs/kd_logit_alpha01.yaml", True),
    "kd_logit_alpha03":                  ("configs/kd_logit_alpha03.yaml", True),
    "kd_logit_alpha05":                  ("configs/kd_logit_alpha05.yaml", True),
    "kd_cosine_unw":                     ("configs/kd_cosine_unw.yaml", True),
    "kd_cosine_classweight":             ("configs/kd_cosine_classweight.yaml", True),
    "kd_rkd_unw":                        ("configs/kd_rkd_unw.yaml", True),
    "kd_crd_unw":                        ("configs/kd_crd_unw.yaml", True),
    "kd_hybrid_logit_cosine_unw":        ("configs/kd_hybrid_logit_cosine_unw.yaml", True),
    "kd_hybrid_logit_cosine_immune":     ("configs/kd_hybrid_logit_cosine_immune.yaml", True),
    "baseline_ced":                      ("configs/baseline_ced.yaml", False),
    "baseline_ced_finetune":             ("configs/baseline_ced_finetune.yaml", False),
}
